    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-indigo-600 text-white py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">Find and Book Flights</h1>
          <p className="text-indigo-100">Compare prices and find the best deals on flights</p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex-1">
            <input
              ...
              className="text-black w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none"
              value={searchTerm}
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              className="px-3 py-2 text-black border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none"
              value={sortBy}
          ...
          {sortedFlights.length > 0 ? (
            sortedFlights.map((flight) => (
              <div 
                ...
                onClick={() => router.push(`/flights/${flight._id}`)}
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm text-gray-500">
                    {new Date(flight.departureDate).toLocaleDateString()} • {flight.duration}
                  </p>
